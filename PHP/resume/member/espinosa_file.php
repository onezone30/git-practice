...
<?php
    ...
    $sql = "SELECT first_name, last_name, age, height, weight, dream_job, birthday, address, hobby, elem_school, high_school, senior_school, college, father_name, mother_name FROM members WHERE id = 3";
    ...
    <div class="container">
        <div class="profile">
            <div class="profile_image">
                <img src="/PHP/resume/images/espinosa_image.jpg" alt="">
            </div>
        <table border="10">
            <tr>
                <th>Fields</th>
